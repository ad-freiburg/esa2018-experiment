...
For more details on the setup, the results, the data, and a script to evaluate and visualize the data in various ways, see the website of the experiment.<sup>2</sup>
...
This correlates well with the experience that PC members are willing to adapt their initial scores *once*, after reading the reviews from the other PC members.
After that, their opinion is more or less fixed.
